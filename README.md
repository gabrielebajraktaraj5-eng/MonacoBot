# MonacoBot - Ultimate Discord Bot

**MonacoBot** is a powerful, feature-rich Discord bot designed to enhance your server experience with comprehensive moderation tools, engaging economy systems, utility features, and much more. Built with modern Discord.js v14 and PostgreSQL for optimal performance and data persistence.
...
MonacoBot offers a complete suite of tools for Discord server management and community engagement:
...
[**MonacoBot Setup Tutorial**](https://www.youtube.com/@TouchDisc)

## Docker Deployment (Recommended)

MonacoBot is fully containerized for easy deployment.

1. **Clone the repository:**
   ```bash
   git clone https://github.com/codebymitch/MonacoBot.git
   cd MonacoBot
   ```
...
```bash
docker pull ghcr.io/codebymitch/MonacoBot:main
```
...
3. **Configure Environment Variables**
   ...
   POSTGRES_URL=postgresql://postgres:yourpassword@localhost:5432/MonacoBot
   POSTGRES_HOST=localhost
   POSTGRES_PORT=5432
   POSTGRES_DB=MonacoBot
   ...
   - If your chosen `PORT` is already used, MonacoBot automatically tries the next port(s)
...
4. **Setup PostgreSQL Database** (Optional but recommended)
   ...
   createdb MonacoBot
   createuser MonacoBot
   psql -c "ALTER USER MonacoBot PASSWORD 'yourpassword';"
   psql -c "GRANT ALL PRIVILEGES ON DATABASE MonacoBot TO MonacoBot;"
   ```
...
MonacoBot requires the following Discord intents:
- **Guilds**
- **Guild Messages**
- **Message Content**
- **Guild Members**
...
We welcome contributions to MonacoBot! Here's how you can help:
...
MonacoBot is released under the MIT License. See [LICENSE](LICENSE) for details.

## Thank You

Thank you for choosing MonacoBot for your Discord server! We're constantly working to improve and add new features based on community feedback.
